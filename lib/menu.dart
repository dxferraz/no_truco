              ...
              children: [
                TextButton(
                  style: TextButton.styleFrom(
                    ...
                    textStyle: const TextStyle(fontFamily:'CairoSBold', fontSize: 25),
                    ),
                  onPressed: ()
                  {Navigator.push(context,MaterialPageRoute(builder: (context) => const Historic()),);},
            ...
            Row(
              ...
              children: [
                TextButton(
                  style: TextButton.styleFrom(
                    primary: const Color(0xFFCCCCCC),
                    textStyle: const TextStyle( fontFamily: 'Conthrax', fontSize: 25),
                    ),
                  onPressed: ()
                  {Navigator.push(context,MaterialPageRoute(builder: (context) => const Historic()),);},
                  child: const Text("Dxferraz"))
              ],
            ),
          ],
        ),
